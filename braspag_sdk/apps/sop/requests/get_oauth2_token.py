...
from braspag_sdk.apps.sop.data import SilentOrderPostCredentials
from braspag_sdk.apps.sop.environment import SOPEnvironment


class Oauth2Token(Base):

    def __init__(self, *, sop_credentials: SilentOrderPostCredentials, environment: SOPEnvironment):
        cred = (sop_credentials.client_id + ':' + sop_credentials.client_secret).encode('utf-8')
